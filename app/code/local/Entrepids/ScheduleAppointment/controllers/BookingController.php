...
class Entrepids_ScheduleAppointment_BookingController extends Mage_Core_Controller_Front_Action{
    ...
    private function sendNotification($to,$data){
        ...
        try{
            ...
            $tit = 'Me interesa su producto '.$data['product_name'];
            $email_name = Mage::getStoreConfig('trans_email/ident_general/name');
            $email =      Mage::getStoreConfig('trans_email/ident_general/email');
            $to2 = 'nestle-professional@centrodecontacto.mx';
            $email_name = 'Prospecto CPMN';
            ...
            Mage::log( $s, Zend_Log::INFO, 'citas.log');
