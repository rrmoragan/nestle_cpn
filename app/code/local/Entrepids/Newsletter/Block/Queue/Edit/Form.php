...
class Entrepids_Newsletter_Block_Queue_Edit_Form extends Mage_Adminhtml_Block_Newsletter_Queue_Edit_Form
{
    protected function _prepareForm()
    {
        $catalogs = Mage::getModel("entrepids_newsletter/catalog")->getCollection();
        $catalogArray =[];
        $catalogArray[""] = "Elige una categoría";
        foreach($catalogs as $catalog){
           $catalogArray[$catalog->getId()] = $catalog->getName();
        }
        ...
        $fieldset->addField('sender_name', 'text', array(
          ...
          $fieldset->addField('catalog', 'select', array(
            'name'     => 'catalog',
            'label'    => Mage::helper('newsletter')->__('Elige un grupo de usuarios'),
            'title'    => Mage::helper('newsletter')->__('Elige un grupo de usuarios'),
            'required' => true,
