...
*/
class Entrepids_Cronscheduler_Model_Observer{
    /**
     * Process cron queue
    ...
    public function dispatch(Varien_Event_Observer $observer){
        ...
        $scheduleManager = Mage::getModel('cronscheduler/scheduleManager'); /* @var $scheduleManager Entrepids_Cronscheduler_Model_ScheduleManager */
    ...
    public function dispatchAlways(Varien_Event_Observer $observer){
        ...
        $scheduleManager = Mage::getModel('cronscheduler/scheduleManager'); /* @var $scheduleManager Aoe_Scheduler_Model_ScheduleManager */
