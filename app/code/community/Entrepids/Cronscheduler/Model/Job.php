...
*/
/**
 * @method Entrepids_Cronscheduler_Model_Job setJobCode($jobCode)
 * @method string getJobCode()
 * @method Entrepids_Cronscheduler_Model_Job setName($name)
 * @method Entrepids_Cronscheduler_Model_Job setDescription($description)
 * @method string getDescription()
 * @method Entrepids_Cronscheduler_Model_Job setShortDescription($shortDescription)
 * @method string getShortDescription()
 * @method Entrepids_Cronscheduler_Model_Job setScheduleCronExpr($scheduleCronExpr)
 * @method string getScheduleCronExpr()
 * @method Entrepids_Cronscheduler_Model_Job setScheduleConfigPath($scheduleConfigPath)
 * @method string getScheduleConfigPath()
 * @method Entrepids_Cronscheduler_Model_Job setRunModel($runModel)
 * @method string getRunModel()
 * @method Entrepids_Cronscheduler_Model_Job setParameters($parameters)
 * @method string getParameters()
 * @method Entrepids_Cronscheduler_Model_Job setGroups($groups)
 * @method string getGroups()
 * @method Entrepids_Cronscheduler_Model_Job setOnSuccess($onSuccess)
 * @method string getOnSuccess()
 * @method Entrepids_Cronscheduler_Model_Job load($jobCode)
 * @method Entrepids_Cronscheduler_Model_Resource_Job getResource()
 * @method Entrepids_Cronscheduler_Model_Resource_Job_Collection getCollection()
 * @method Entrepids_Cronscheduler_Model_Resource_Job_Collection getResourceCollection()
 */
class Entrepids_Cronscheduler_Model_Job extends Mage_Core_Model_Abstract
{
    /**
     ...
     * @var string
     */
    protected $_eventPrefix = 'cronscheduler_job';
    ...
    {
        $this->_setResourceModel('cronscheduler/job', 'cronscheduler/job_collection');
    }
    ...
    {
        return ($this->getCronExpression() == 'always' || $this->getCronExpression() == '* * * * *' );
    }
    ...
    {
        return in_array($this->getData('visible'), array(true, 'true', 1, '1'), true);
    }
}
