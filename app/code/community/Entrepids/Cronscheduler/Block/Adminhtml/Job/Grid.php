...
*/
class Entrepids_Cronscheduler_Block_Adminhtml_Job_Grid extends Mage_Adminhtml_Block_Widget_Grid
{
    /**
     * Constructor
     */
    ...
    protected function _prepareCollection()
    {
        ...
        $collection = Mage::getSingleton('cronscheduler/job')->getCollection()->getOnlyVisibleJobs();
