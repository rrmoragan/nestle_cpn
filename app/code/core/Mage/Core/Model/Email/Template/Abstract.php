...
abstract class Mage_Core_Model_Email_Template_Abstract extends Mage_Core_Model_Template
{
    ...
    {
        Mage::log('getTemplateByConfigPath()', Zend_Log::INFO, 'email.log');
    ...
    {
        Mage::log('loadByConfigPath()', Zend_Log::INFO, 'email.log');
    ...
    {
        Mage::log('_getLogoUrl()', Zend_Log::INFO, 'email.log');
    ...
    {
        Mage::log('_getLogoAlt()', Zend_Log::INFO, 'email.log');
    ...
    {
        Mage::log('_addEmailVariables()', Zend_Log::INFO, 'email.log');
        ...
        if (!isset($variables['fecha'])) {
            $variables['fecha'] = date( 'Y/m/d', time() );
        }
        ...
        //Mage::log('_addEmailVariables() ==> '.print_r($variables,true), Zend_Log::INFO, 'email.log');
        return $variables;
    }
    ...
    {
        Mage::log('_applyInlineCss()', Zend_Log::INFO, 'email.log');
    ...
    {
        Mage::log('_getCssFileContent()', Zend_Log::INFO, 'email.log');
    ...
    {
        Mage::log('_getCssByConfig()', Zend_Log::INFO, 'email.log');
    ...
    {
        Mage::log('_getNonInlineCssTag()', Zend_Log::INFO, 'email.log');
