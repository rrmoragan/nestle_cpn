...
class Mage_Core_Model_Email_Template extends Mage_Core_Model_Email_Template_Abstract
{
    ...
    {
        Mage::log('Mage_Core_Model_Email_Template ==> getMail()', Zend_Log::INFO, 'email.log');
    ...
    {
        Mage::log('Mage_Core_Model_Email_Template ==> setTemplateFilter()', Zend_Log::INFO, 'email.log');
    ...
    {
        Mage::log('Mage_Core_Model_Email_Template ==> getTemplateFilter()', Zend_Log::INFO, 'email.log');
        ...
        //Mage::log($this->_templateFilter, Zend_Log::INFO, 'email.log');
    ...
    {
        Mage::log('Mage_Core_Model_Email_Template ==> loadByCode()', Zend_Log::INFO, 'email.log');
    ...
    {
        Mage::log('Mage_Core_Model_Email_Template ==> loadDefault()', Zend_Log::INFO, 'email.log');
    ...
    {
        Mage::log('Mage_Core_Model_Email_Template ==> getDefaultTemplates()', Zend_Log::INFO, 'email.log');
    ...
    {
        Mage::log('Mage_Core_Model_Email_Template ==> getDefaultTemplatesAsOptionsArray()', Zend_Log::INFO, 'email.log');
    ...
    {
        Mage::log('Mage_Core_Model_Email_Template ==> getId()', Zend_Log::INFO, 'email.log');
    ...
    {
        Mage::log('Mage_Core_Model_Email_Template ==> setId()', Zend_Log::INFO, 'email.log');
    ...
    {
        Mage::log('Mage_Core_Model_Email_Template ==> isValidForSend()', Zend_Log::INFO, 'email.log');
    ...
    public function getType(){
        Mage::log('Mage_Core_Model_Email_Template ==> getType() ==> '.print_r( $this->getTemplateType(),true ), Zend_Log::INFO, 'email.log');
    ...
    {
        Mage::log('Mage_Core_Model_Email_Template ==> getProcessedTemplate()', Zend_Log::INFO, 'email.log');
    ...
    {
        Mage::log('Mage_Core_Model_Email_Template ==> getPreparedTemplateText()', Zend_Log::INFO, 'email.log');

        if ($this->isPlain() && $html) {
            Mage::log('Mage_Core_Model_Email_Template ==> html isPlain() ==> '.print_r( $html,true ), Zend_Log::INFO, 'email-'.time().'.html');

            return $html;
        } elseif ($this->isPlain()) {
            Mage::log('Mage_Core_Model_Email_Template ==> html !isPlain() ==> '.print_r( $this->getTemplateText(),true ), Zend_Log::INFO, 'email-'.time().'.html');

            return $this->getTemplateText();
        }

        Mage::log('Mage_Core_Model_Email_Template ==> html ==> '.print_r( $this->_applyInlineCss($html),true ), Zend_Log::INFO, 'email-'.time().'.html');
    ...
    {
        Mage::log('Mage_Core_Model_Email_Template ==> getInclude()', Zend_Log::INFO, 'email.log');
    ...
    {
        Mage::log('Mage_Core_Model_Email_Template ==> send()', Zend_Log::INFO, 'email.log');
    ...
    {
        Mage::log('Mage_Core_Model_Email_Template ==> sendTransactional()', Zend_Log::INFO, 'email.log');
    ...
    {
        Mage::log('Mage_Core_Model_Email_Template ==> getProcessedTemplateSubject()', Zend_Log::INFO, 'email.log');
    ...
    {
        Mage::log('Mage_Core_Model_Email_Template ==> addBcc()', Zend_Log::INFO, 'email.log');
    ...
    {
        Mage::log('Mage_Core_Model_Email_Template ==> setReturnPath()', Zend_Log::INFO, 'email.log');
    ...
    {
        Mage::log('Mage_Core_Model_Email_Template ==> setReplyTo()', Zend_Log::INFO, 'email.log');
    ...
    {
        Mage::log('Mage_Core_Model_Email_Template ==> _parseVariablesString()', Zend_Log::INFO, 'email.log');
    ...
    {
        Mage::log('Mage_Core_Model_Email_Template ==> getVariablesOptionArray()', Zend_Log::INFO, 'email.log');
    ...
    {
        Mage::log('Mage_Core_Model_Email_Template ==> _beforeSave()', Zend_Log::INFO, 'email.log');
