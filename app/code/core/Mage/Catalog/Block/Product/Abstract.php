...
abstract class Mage_Catalog_Block_Product_Abstract extends Mage_Core_Block_Template
{
    ...
    {
	//echo '<br>productType ==> '.print_r( $productType, true );
	//echo '<br>_getPriceBlock ==> '.print_r( $this->_getPriceBlock($productType), true );
	//echo '<br>setTemplate ==> '.print_r($this->_getPriceBlock($productType)->setTemplate($this->_getPriceBlockTemplate($productType)), true );
	//echo '<br>setUseLinkForAsLowAs ==> '.print_r( $this->_getPriceBlock($productType)->setTemplate($this->_getPriceBlockTemplate($productType))->setUseLinkForAsLowAs($this->_useLinkForAsLowAs), true );
	...
	$type_id = $product->getTypeId();
	    ...
	    /*echo '<br>realPrice ==> '. $this->_preparePriceRenderer($type_id)
                ->setProduct($product)
                ->setDisplayMinimalPrice($displayMinimalPrice)
                ->setIdSuffix($idSuffix);*/
        }
        
//echo '<br>dat 01 ==> '.$this->_preparePriceRenderer($type_id)->setProduct($product)->setDisplayMinimalPrice($displayMinimalPrice)->setIdSuffix($idSuffix)->tohtml();
//echo '<br>dat 02 ==> '.$this->_preparePriceRenderer($type_id)->setProduct($product)->setDisplayMinimalPrice($displayMinimalPrice)->tohtml();
//echo '<br>dat 03 ==> '.$this->_preparePriceRenderer($type_id)->setProduct($product)->tohtml();
//echo '<br>dat 04 ==> '.$this->_preparePriceRenderer($type_id)->tohtml();
//echo '<br>dat 01 ==> '.print_r( $this->_preparePriceRenderer($type_id)->setProduct($product)->setDisplayMinimalPrice($displayMinimalPrice)->setIdSuffix($idSuffix),true );
//echo '<br>dat 02 ==> '.print_r( $this->_preparePriceRenderer($type_id)->setProduct($product)->setDisplayMinimalPrice($displayMinimalPrice),true );
//echo '<br>dat 03 ==> '.print_r( $this->_preparePriceRenderer($type_id)->setProduct($product),true );
//echo '<br>dat 04 ==> '.print_r( $this->_preparePriceRenderer($type_id),true );

	/*echo '<br>data ==> '.$this->_preparePriceRenderer($type_id)
            ->setProduct($product)
            ->setDisplayMinimalPrice($displayMinimalPrice)
            ->setIdSuffix($idSuffix)->tohtml();*/
