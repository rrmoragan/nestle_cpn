...
abstract class Mage_Shipping_Model_Carrier_Abstract extends Varien_Object
{
    ...
    public function getFinalPriceWithHandlingFee($cost)
    {
        ...
        if (!$handlingType) {
            $handlingType = self::HANDLING_TYPE_FIXED; //  const HANDLING_TYPE_FIXED = 'F';
        }
        $handlingAction = $this->getConfigData('handling_action');
        if (!$handlingAction) {
            $handlingAction = self::HANDLING_ACTION_PERORDER;   //  const HANDLING_ACTION_PERORDER = 'O';
        }
    ...
    {
        if ($handlingType == self::HANDLING_TYPE_PERCENT) { // const HANDLING_TYPE_PERCENT = 'P';
