...
Minicart.prototype = {
    ...
    removeItem: function(el) {
        var cart = this;
        $j('.remove2cart_confirm_shadow').show();
        $j('.remove2cart_confirm_message').html(el.data('confirm'));
        function confirm(){
            cart.hideMessage();
            cart.showOverlay();
            clean();
        ...
        function clean(){
            $j('.remove2cart_confirm_shadow').hide();
            $j('.remove2cart_confirm_button_ok').off('click'); 
            $j('.remove2cart_confirm_button_cancel').off('click'); 
        }

        $j('.remove2cart_confirm_button_ok').on('click',confirm);
        $j('.remove2cart_confirm_button_cancel').on('click',clean);
