 ...
 */
var loadPayment = 0;
var loadShippingMethod = 0;
var steps_checkout = ["billing"];
 
timelineCheckoutChange = function(step){
    console.log( 'timelineCheckoutChange()' );
        
    if(steps_checkout.includes(step)){
        steps_checkout.splice(steps_checkout.indexOf(step)+1,steps_checkout.length)
    }else{
        steps_checkout.push(step);
    }
    
    $$('.timeline .time_main .step.active').each(function(ele){
        ele.removeClassName('active');
    });

    steps_checkout.each(function(ele){
        $('step-'+ele).addClassName('active');
    });
}
...
Checkout.prototype = {
    ...
    _onSectionClick: function(event) {
        console.log( 'Checkout._onSectionClick' );
        
        var section = $(Event.element(event).up('.section'));
        if (section.hasClassName('allow')) {
            Event.stop(event);
            var section_name = section.readAttribute('id').replace('opc-', '');
            this.gotoSection(section_name, false);
            timelineCheckoutChange(section_name);
            return false;
        }
    },

    ajaxFailure: function(){
        console.log( 'Checkout.ajaxFailure' );
        
        //location.href = encodeURI(this.failureUrl);
    },

    reloadProgressBlock: function(toStep) {
        console.log( 'Checkout.reloadProgressBlock' );
    ...
    reloadStep: function(prevStep) {
        console.log( 'Checkout.reloadStep' );
    ...
    _disableEnableAll: function(element, isDisabled) {
        console.log( 'Checkout._disableEnableAll' );
    ...
    setLoadWaiting: function(step, keepDisabled) {
        console.log( 'Checkout.setLoadWaiting' );
    ...
    resetPreviousSteps: function () {
        console.log( 'Checkout.resetPreviousSteps' );
    ...
    changeSection: function (section) {
        console.log( 'Checkout.changeSection' );
    ...
    setMethod: function(){
        console.log( 'Checkout.setMethod' );
    ...
    setBilling: function() {
        console.log( 'Checkout.setBilling' );
    ...
    setShipping: function() {
        console.log( 'Checkout.setShipping' );
    ...
    setShippingMethod: function() {
        console.log( 'Checkout.setShippingMethod' );
    ...
    setPayment: function() {
        console.log( 'Checkout.setPayment' );
    ...
    setReview: function() {
        console.log( 'Checkout.setReview' );
    ...
    back: function(){
        ...
        timelineCheckoutChange(section);
    },

    setStepResponse: function(response){
        console.log( 'Checkout.setStepResponse' );
        ...
        if (response.goto_section) {
            ...
            timelineCheckoutChange(response.goto_section);
            return true;
        }
...
Billing.prototype = {
    initialize: function(form, addressUrl, saveUrl){
        console.log( 'Billing.initialize' );
    ...
    setAddress: function(addressId){
        console.log( 'Billing.setAddress' );
            ...
            new Ajax.Request(
                this.addressUrl+addressId,
                {
                    ...
                    onFailure: function(){
                        ...
                        console.log( 'Billing.setAddress ==> ajaxFailure' );
                    }
                }
            );
        }
    ...
    newAddress: function(isNew){
        console.log( 'Billing.newAddress' );
    ...
    resetSelectedAddress: function(){
        console.log( 'Billing.resetSelectedAddress' );
    ...
    setUseForShipping: function(flag) {
        console.log( 'Billing.setUseForShipping' );
        ...
        if (validator.validate()) {
            ...
            new Ajax.Request(
                this.saveUrl,
                {
                    ...
                    onFailure: function(){
                        checkout.ajaxFailure.bind(checkout);
                        console.log( 'Billing.save ==> ajaxFailure' );
                    },
    ...
    resetLoadWaiting: function(transport){
        console.log( 'Billing.resetLoadWaiting' );
...
Shipping.prototype = {
    initialize: function(form, addressUrl, saveUrl, methodsUrl){
        console.log('shipping.initialize');
    ...
    setAddress: function(addressId){
        console.log('shipping.setAddress');
        ...
        if (addressId) {
            new Ajax.Request(
                this.addressUrl+addressId,
                {
                    ...
                    onFailure: function(){
                        checkout.ajaxFailure.bind(checkout);
                        console.log( 'shipping.setAddress ==> ajaxFailure' );
                    }
                }
            );
        }
    ...
    newAddress: function(isNew){
        console.log('shipping.newAddress');
    ...
    resetSelectedAddress: function(){
        console.log('shipping.resetSelectedAddress');
    ...
    setSameAsBilling: function(flag) {
        console.log('shipping.setSameAsBilling');
    ...
    syncWithBilling: function () {
        console.log('shipping.syncWithBilling');
    ...
    setRegionValue: function(){
        console.log('shipping.setRegionValue');

        $('shipping:region').value = $('billing:region').value;
    },

    save: function(){
        console.log('shipping.save');
        ...
        if (validator.validate()) {
            ...
            new Ajax.Request(
                this.saveUrl,
                {
                    ...
                    onFailure: function(){
                        checkout.ajaxFailure.bind(checkout);
                        console.log( 'shipping.save ==> ajaxFailure' );
                    },
                    parameters: Form.serialize(this.form)
                }
            );
    ...
    resetLoadWaiting: function(){
        console.log('shipping.resetLoadWaiting');

        checkout.setLoadWaiting(false);
    },

    nextStep: function(transport){
        console.log('shipping.nextStep');
        for( i=1; i<=8; i++ ){
            if( transport.responseText.substr(0,3) == '111' ){
                transport.responseText = transport.responseText.substr(3);
                console.log('cut_json '+i);
            }
        }
        ...
        if(is_3a == 1 && loadShippingMethod == 0){
            loadShippingMethod = 1;
            shippingMethod.save();
        }
        /*
...
ShippingMethod.prototype = {
    initialize: function(form, saveUrl){
        console.log('ShippingMethod.initialize');
    ...
    validate: function() {
        console.log('ShippingMethod.validate');
        ...
        document.getElementById('step_shipping_method_error').innerHTML = Translator.translate('Please specify shipping method.').stripTags();
        return false;
    },

    save: function(){
        console.log('ShippingMethod.save');
        ...
        if (this.validate()) {
            ...
            new Ajax.Request(
                this.saveUrl,
                {
                    ...
                    onFailure: function(){
                        checkout.ajaxFailure.bind(checkout);
                        console.log( 'ShippingMethod.save ==> ajaxFailure' );
                    },
                    parameters: Form.serialize(this.form)
                }
            );
    ...
    resetLoadWaiting: function(transport){
        console.log('ShippingMethod.resetLoadWaiting');

        checkout.setLoadWaiting(false);
    },

    nextStep: function(transport){
        console.log('ShippingMethod.nextStep');
...
Payment.prototype = {
    ...
    addBeforeInitFunction : function(code, func) {
        console.log( 'Payment.addBeforeInitFunction' );

        this.beforeInitFunc.set(code, func);
    },

    beforeInit : function() {
        console.log( 'Payment.beforeInit' );
    ...
    addAfterInitFunction : function(code, func) {
        console.log( 'Payment.addAfterInitFunction' );

        this.afterInitFunc.set(code, func);
    },

    afterInit : function() {
        console.log( 'Payment.afterInit' );
    ...
    switchMethod: function(method){
        console.log( 'Payment.switchMethod' );
    ...
    changeVisible: function(method, mode) {
        console.log( 'Payment.changeVisible' );
    ...
    addBeforeValidateFunction : function(code, func) {
        console.log( 'Payment.addBeforeValidateFunction' );

        this.beforeValidateFunc.set(code, func);
    },

    beforeValidate : function() {
        console.log( 'Payment.beforeValidate' );
    ...
    validate: function() {
        ...
        document.getElementById('step_paymeth_method_error').innerHTML = Translator.translate('Please specify payment method.').stripTags();
        //alert(Translator.translate('Please specify payment method.').stripTags());
        return false;
    },

    addAfterValidateFunction : function(code, func) {
        console.log( 'Payment.addAfterValidateFunction' );

        this.afterValidateFunc.set(code, func);
    },

    afterValidate : function() {
        console.log( 'Payment.afterValidate' );
        ...
        if (this.validate() && validator.validate()) {
            ...
            new Ajax.Request(
                this.saveUrl,
                {
                    ...
                    onFailure: function(){
                        checkout.ajaxFailure.bind(checkout);
                        console.log( 'Payment.save ==> ajaxFailure' );
                        console.log( array_form );
                        console.log( Form.serialize( array_form ) );
                    },
                    parameters: Form.serialize( array_form )
                }
            );
        }
    },
    ...
    resetLoadWaiting: function(){
        console.log( 'Payment.resetLoadWaiting' );

        checkout.setLoadWaiting(false);
    },

    nextStep: function(transport){
        console.log( 'Payment.nextStep' );
    ...
    initWhatIsCvvListeners: function(){
        console.log( 'Payment.initWhatIsCvvListeners' );
...
Review.prototype = {
    ...
    save: function(){
        ...
        new Ajax.Request(
            this.saveUrl,
            {
                ...
                onFailure: function(){
                    checkout.ajaxFailure.bind(checkout);
                    console.log( 'Review.save ==> ajaxFailure' );
                }
            }
        );
    },
    ...
    resetLoadWaiting: function(transport){
        console.log( 'Review.resetLoadWaiting' );
        
        checkout.setLoadWaiting(false, this.isSuccess);
    },

    nextStep: function(transport){
        console.log( 'Review.nextStep' );
