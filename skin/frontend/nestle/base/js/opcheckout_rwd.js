...
function hideBillingStep()
{
    ...
    if ($j('#is_bill').is(':checked')) 
    {
        ...
        */
        ...
        /* activando el paso shipping que no se activa al ser saltado */
        steps_checkout.push("shipping");
        $j('#step-shipping').addClass('active');    /* activa el bullet de la barra de navegacion */
        console.log( 'steps_checkout ==> ' );
        console.log( steps_checkout );
    }
    else
    {
